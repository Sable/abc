...
a module. It first contained the proposal on the \texttt{module} access modifier and the syntax for module membership.
...
The design of other various module systems have inspired several features in the 
...
but in the context of mixin and aspect composition.
