...
if(computeDUbefore_int_Variable_values == null) computeDUbefore_int_Variable_values = new java.util.HashMap(4);
 ...
 @SuppressWarnings({"unchecked", "cast"})     public Expr first() {
    ...
    private Expr first_compute() {  return getNumInit() == 0 ?
 ...
 @SuppressWarnings({"unchecked", "cast"})     public TypeDecl declType() {
    ...
    // Declared in ControlFlowGraph.jrag at line 230
    ...
    // Declared in ControlFlowGraph.jrag at line 229
