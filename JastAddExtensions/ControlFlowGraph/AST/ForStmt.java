...
if(localVariableDeclaration_String_values == null) localVariableDeclaration_String_values = new java.util.HashMap(4);
 ...
 @SuppressWarnings({"unchecked", "cast"})     public boolean canCompleteNormally() {
    ...
    // Declared in ControlFlowGraph.jrag at line 328
 @SuppressWarnings({"unchecked", "cast"})     public SmallSet succ() {
    ...
    private SmallSet succ_compute() {  return getNumInitStmt() > 0 ?
		SmallSet.empty().union(getInitStmt(0)) : 
		SmallSet.empty().union(getCondition().first());  }

    // Declared in ControlFlowGraph.jrag at line 394
 @SuppressWarnings({"unchecked", "cast"})     public CFGNode targetForContinue() {
    ...
    private CFGNode targetForContinue_compute() {  return getNumUpdateStmt() > 0 ?
...
if(lookupVariable_String_values == null) lookupVariable_String_values = new java.util.HashMap(4);
    ...
    // Declared in ControlFlowGraph.jrag at line 335
    ...
    public SmallSet Define_SmallSet_followingWhenTrue(ASTNode caller, ASTNode child) {
        if(caller == getConditionOptNoTransform()) {
            return SmallSet.empty().union(getStmt());
        }
