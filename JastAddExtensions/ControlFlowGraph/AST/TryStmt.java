...
public class TryStmt extends Stmt implements Cloneable, FinallyHost {
  ...
  public void toString(StringBuffer s) {
    ...
    // Declared in ControlFlowGraph.jrag at line 764
...
if(reachableThrow_CatchClause_values == null) reachableThrow_CatchClause_values = new java.util.HashMap(4);
 ...
 @SuppressWarnings({"unchecked", "cast"})     public boolean canCompleteNormally() {
    ...
    // Declared in ControlFlowGraph.jrag at line 591
 @SuppressWarnings({"unchecked", "cast"})     public SmallSet succ() {
    ...
    private SmallSet succ_compute() {  return SmallSet.empty().union(getBlock());  }
 ...
 @SuppressWarnings({"unchecked", "cast"})     public SmallSet collectBranches() {
    ...
    private SmallSet collectBranches_compute() {
		// Try
   ...
   int childIndex = caller.getIndexOfChild(child);
{
    ...
    // Declared in ControlFlowGraph.jrag at line 595
    public SmallSet Define_SmallSet_following(ASTNode caller, ASTNode child) {
      ...
      int index = caller.getIndexOfChild(child);
            return hasFinally() ? SmallSet.empty().union(getFinally()) : following();
        }
        if(caller == getBlockNoTransform()) {
            return hasFinally() ? SmallSet.empty().union(getFinally()) : following();
        }
