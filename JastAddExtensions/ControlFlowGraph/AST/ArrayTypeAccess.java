...
private String refined_PrettyPrint_ArrayTypeAccess_dumpString()
{ return getClass().getName(); }
 ...
 @SuppressWarnings({"unchecked", "cast"})     public TypeDecl decl() {
    ...
    // Declared in MyAnalysis.jrag at line 96
 @SuppressWarnings({"unchecked", "cast"})     public String dumpString() {
    ...
    private String dumpString_compute() {
	    ...
	    buf.append(refined_PrettyPrint_ArrayTypeAccess_dumpString());
 ...
 @SuppressWarnings({"unchecked", "cast"})     public Expr first() {
    ...
    private Expr first_compute() {  return getAccess().first();  }
