            ...
            if(isFinal && num == boundariesCrossed)
{
 ...
 @SuppressWarnings({"unchecked", "cast"})     public boolean canCompleteNormally() {
    ...
    // Declared in ControlFlowGraph.jrag at line 294
 @SuppressWarnings({"unchecked", "cast"})     public SmallSet succ() {
    ...
    // Declared in ControlFlowGraph.jrag at line 392
 @SuppressWarnings({"unchecked", "cast"})     public CFGNode targetForContinue() {
    ...
    // Declared in ControlFlowGraph.jrag at line 298
    public SmallSet Define_SmallSet_following(ASTNode caller, ASTNode child) {
        if(caller == getStmtNoTransform()) {
            return SmallSet.empty().union(getCondition().first());
        }
        if(caller == getConditionNoTransform()) {
    ...
    // Declared in ControlFlowGraph.jrag at line 295
