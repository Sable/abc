...
if(isDUafter_Variable_values == null) isDUafter_Variable_values = new java.util.HashMap(4);
 ...
 @SuppressWarnings({"unchecked", "cast"})     public boolean canCompleteNormally() {
    ...
    // Declared in ControlFlowGraph.jrag at line 577
 @SuppressWarnings({"unchecked", "cast"})     public SmallSet succ() {
    ...
    private SmallSet succ_compute() {  return hasResult() ?
    	SmallSet.empty().union(getResult().first()) : followingTarget(this, this);  }

    // Declared in ControlFlowGraph.jrag at line 639
 @SuppressWarnings({"unchecked", "cast"})     public SmallSet collectBranches() {
        SmallSet collectBranches_value = collectBranches_compute();
        return collectBranches_value;
    }

    private SmallSet collectBranches_compute() {  return SmallSet.empty().union(this);  }
 ...
 @SuppressWarnings({"unchecked", "cast"})     public TypeDecl returnType() {
    ...
    // Declared in ControlFlowGraph.jrag at line 581
