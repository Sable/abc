...
public abstract class Expr extends ASTNode<ASTNode> implements Cloneable, CFGNode {
 ...
 @SuppressWarnings({"unchecked", "cast"})     public int uniqueIndex() {
    ...
    private int uniqueIndex_compute() {  return Stmt.uniqueIndex++;  }

    // Declared in MyAnalysis.jrag at line 22
 ...
 @SuppressWarnings({"unchecked", "cast"})     public boolean inStaticContext() {
    ...
    // Declared in ControlFlowGraph.jrag at line 61
 ...
 @SuppressWarnings({"unchecked", "cast"})     public SmallSet followingWhenTrue() {
        SmallSet followingWhenTrue_value = getParent().Define_SmallSet_followingWhenTrue(this, null);
        return followingWhenTrue_value;
    }

    // Declared in ControlFlowGraph.jrag at line 171
 @SuppressWarnings({"unchecked", "cast"})     public SmallSet followingWhenFalse() {
        SmallSet followingWhenFalse_value = getParent().Define_SmallSet_followingWhenFalse(this, null);
