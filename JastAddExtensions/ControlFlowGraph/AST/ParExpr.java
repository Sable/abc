...
public class ParExpr extends PrimaryExpr implements Cloneable {
 ...
 @SuppressWarnings({"unchecked", "cast"})     public boolean staticContextQualifier() {
    ...
    // Declared in ControlFlowGraph.jrag at line 112
 @SuppressWarnings({"unchecked", "cast"})     public Expr first() {
        Expr first_value = first_compute();
        return first_value;
    }

    private Expr first_compute() {  return getExpr().first();  }

    // Declared in ControlFlowGraph.jrag at line 214
    ...
    // Declared in ControlFlowGraph.jrag at line 113
    ...
    // Declared in ControlFlowGraph.jrag at line 213
