package org.jastadd.plugin.view;
...
public abstract class JastAddBaseHierarchyView<T> extends ViewPart {
	...
	protected static JastAddBaseHierarchyView activate(String viewID) throws CoreException {
		JastAddBaseHierarchyView view = (JastAddBaseHierarchyView) PlatformUI
