...
//		"lucene-3.0.1",  // 84 KSLOC
	...
	public void testBenchmark() throws Exception{
		for (String benchmarkprogram : benchmarkprograms) {
			...
			lastProg = benchmarkprogram;
			System.out.println();
			System.out.println("Next Projet:" + benchmarkprogram);
			performChanges(log);
			log.done();
		}
	}
	...
	protected Program getProgram() throws Exception{
		return compile(lastProg);
	}
	
	abstract protected String name();
	abstract protected void performChanges(Log log) throws Exception;
}
