...
An expression is extractible if its type is not \code{void}, it is not a reference to a type or package, and it is not the keyword \code{super}; furthermore, it is not on the right-hand side of a dot.
