...
This refactoring converts a local class to a member class. Implemented in \sourcelink{TypePromotion/LocalClassToMemberClass.jrag}; see Algorithms~\ref{alg:ConvertLocalToMemberClass}, \ref{alg:CloseOverTypeVariables}, \ref{alg:CloseOverLocalVariables}.
