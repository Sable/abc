...
This refactoring creates a static method $m'$ in type $B$ that delegates to a method $m$ in type $A$. Implemented in \sourcelink{IntroduceIndirection/IntroduceIndirection.jrag}.
