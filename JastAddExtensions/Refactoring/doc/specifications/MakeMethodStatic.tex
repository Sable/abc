...
This refactoring makes a method static. Implemented in \sourcelink{MakeMethodStatic/MakeMethodStatic.jrag}; see Algorithms~\ref{alg:MakeMethodStatic},~\ref{alg:},~\ref{alg:}.
