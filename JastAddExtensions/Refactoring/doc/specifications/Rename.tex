...
Refactoring \refactoring{Rename Type} changes the name of a type $T$ to $n$.  It is fairly straightforward, except for the well-formedness checks and the treatment of import declarations.
