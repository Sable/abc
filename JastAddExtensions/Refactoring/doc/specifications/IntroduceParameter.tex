...
This refactoring turns an expression into a parameter of the surrounding method. Implemented in \sourcelink{ChangeMethodSignature/IntroduceParameter.jrag}.
