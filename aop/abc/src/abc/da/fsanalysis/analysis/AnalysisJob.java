...
public class AnalysisJob {
	 ...
	 */
	public AnalysisJob(SootMethod m, TracePattern tm, Set<Shadow> shadowsForMethodAndTracePattern, CallGraph abstractedCallGraph, Map<SootMethod, Set<Shadow>> methodToEnabledTMShadows) {
		this.m = m;
		this.tm = tm;
		this.methodToTMShadows = methodToEnabledTMShadows;
		
		this.shadowsForMethodAndTracePattern = Collections.unmodifiableSet(shadowsForMethodAndTracePattern);		
        ...
        overlappingShadows.removeAll(shadowsForMethodAndTracePattern);
	...
	public Set<Shadow> allTMShadowsInMethod() {
		return shadowsForMethodAndTracePattern;
	}
