...
public class ShadowComparator {
	...
	public boolean compatibleBindings(Shadow s1, Shadow s2) {
		assert s1.belongsToDependentAdvice();
		assert s2.belongsToDependentAdvice();
		
		String adviceName1 = s1.dependentAdviceName();
		String adviceName2 = s2.dependentAdviceName();
