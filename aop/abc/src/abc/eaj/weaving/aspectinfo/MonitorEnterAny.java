...
import abc.eaj.weaving.matching.MonitorEnterShadowMatch;
 ...
 *  @author Eric Bodden
 */
public class MonitorEnterAny extends DynamicValuePointcut {

    public MonitorEnterAny(Position pos) {
        super(pos);
    }
    ...
    public final Residue matchesAt(MatchingContext mc) {
        ...
        if(!(sm instanceof MonitorEnterShadowMatch))
        	return NeverMatch.v();
        
        Immediate syncValue = ((MonitorEnterShadowMatch)sm).getSyncValue();
