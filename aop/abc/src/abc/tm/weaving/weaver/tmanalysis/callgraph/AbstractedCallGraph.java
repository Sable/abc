...
public class AbstractedCallGraph extends CallGraph {
	...
	/** Status flag used in the computation. TRUE means <i>have to keep this method</i>, FALSE meanse <i>can leave out this method</i> and <i>COMPUTING</i>
	...
	protected void performAbstraction() {
		resultCache = new IdentityHashMap();
