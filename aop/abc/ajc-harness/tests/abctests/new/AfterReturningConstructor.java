...
public class AfterReturningConstructor {
    public static void main(String[] args) {
        U.ee(U.beforeAdvice + U.ijp);
        U.ee(U.afterReturning + U.ijp);
        U.ee(U.beforeAdvice + U.cjp);
        U.ee(U.c);
...
class U {
    static final String beforeAdvice = "before(): ";
    static final String afterAdvice = "after(): ";
...
aspect A {
    ...
    before(): pc() {
        U.e(U.beforeAdvice + thisJoinPoint);
    }
