...
import abc.ja.eaj.jrag.MemberTypeDecl;
...
class Attributes {
	...
	public Attributes(Parser parser, TypeDecl typeDecl, TypeDecl outerTypeDecl, abc.ja.eaj.jrag.Program classPath) {
		p = parser;
	...
	public void innerClasses(TypeDecl typeDecl, TypeDecl outerTypeDecl, abc.ja.eaj.jrag.Program classPath) {
