...
import abc.ja.cjp.jrag.BytecodeParser;
import abc.ja.cjp.jrag.CompilationUnit;
import abc.ja.cjp.jrag.JavaParser;
import abc.ja.cjp.jrag.Program;
		...
		program.initJavaParser(
	      new JavaParser() {
	        public CompilationUnit parse(InputStream is, String fileName) throws IOException, beaver.Parser.Exception {
	          return new abc.ja.cjp.parse.JavaParser().parse(is, fileName, error_queue);
	        }
	      }
	    );
	}
