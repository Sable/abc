...
import abc.ja.jpi.jrag.BytecodeParser;
...
public class CompileSequence extends abc.ja.cjp.CompileSequence {
		...
		program.initJavaParser(
	      new JavaParser() {
	        public CompilationUnit parse(InputStream is, String fileName) throws IOException, beaver.Parser.Exception {
	          return new abc.ja.jpi.parse.JavaParser().parse(is, fileName, error_queue);
	        }
	      }
	    );
	}
