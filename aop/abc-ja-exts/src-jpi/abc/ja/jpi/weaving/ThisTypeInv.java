 ...
 */
public class ThisTypeInv extends ThisAny {
    private AbcType type;

    public ThisTypeInv(AbcType type,Position pos) {
	super(pos);
	this.type = type;
    }
...
//			AbcType othertype = ((ThisTypeInv)otherpc).getType();
//			if (type.equals(othertype)) {
//				unification.setPointcut(this);
//				return true;
//			} else return false;
//		} else if ((otherpc.getClass() == ThisVarInv.class) && 
...
//				System.out.println("Trying to unify a ThisType "+this+" with a ThisVar: "+otherpc);
//			ThisVarInv othertv = (ThisVarInv)otherpc;
