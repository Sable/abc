 ...
 */
public class TargetVarInv extends TargetAny {
	protected Var var;
	protected WeavingVar weavingVar;

    public TargetVarInv(Var var,Position pos) {
	super(pos);
	this.var = var;
    }
	...
	else return new TargetVarInv(var,getPosition());
    }
...
//			Var othervar = ((TargetVarInv)otherpc).getVar();
...
//					return true;
//				} else {
//					unification.setPointcut(new TargetVarInv(unifiedvar, unifiedvar.getPosition()));
//					return true;
//				} 
//				}
//			} else return false;
