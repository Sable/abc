 ...
 */
public class ArgsInv extends DynamicValuePointcut {
     ...
     */
    public ArgsInv(List args,Position pos) {
        super(pos);
        this.args = args;
    }
    ...
    public Pointcut inline(Hashtable renameEnv,
        ...
        while(it.hasNext()) {
            ...
            if(arg instanceof ArgVar) {
                ...
                if(arg instanceof ArgVarInv) {
                    ArgVarInv argvar=(ArgVarInv) arg;
                    newargs.add(new ArgVarInv(argvar.getVar().rename(renameEnv),
                                           argvar.getPosition()));
                }
                else newargs.add(arg);
            }
        }
        return new ArgsInv(newargs,getPosition());
    ...
    /* (non-Javadoc)
        ...
        public boolean unify(Pointcut otherpc, Unification unification) {
                ...
                if (otherpc.getClass() == this.getClass()) {
                        List/*<ArgPattern>*/ otherargs = ((ArgsInv)otherpc).getArgs();
                        ...
                        case 0  : // Args are not all from same source, need to create a new piece of syntax
                                ArgsInv newpc = new ArgsInv(unifiedargs, getPosition());
