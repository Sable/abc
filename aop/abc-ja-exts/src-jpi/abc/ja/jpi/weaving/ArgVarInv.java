...
import abc.weaving.aspectinfo.CastPointcutVar;
 ...
 */
public class ArgVarInv extends ArgAny {
    private Var var;

    public ArgVarInv(Var var, Position pos) {
	super(pos);
	this.var = var;
    }
...
//			Var othervar = ((ArgVarInv)other).getVar();
