...
import abc.ja.da.jrag.ASTNode;
import abc.ja.da.jrag.BytecodeParser;
import abc.ja.da.jrag.CompilationUnit;
      ...
      program.initJavaParser(
        new JavaParser() {
          public CompilationUnit parse(InputStream is, String fileName) throws IOException, beaver.Parser.Exception {
            return new abc.ja.da.parse.JavaParser().parse(is, fileName, error_queue);
          }
        }
      );
