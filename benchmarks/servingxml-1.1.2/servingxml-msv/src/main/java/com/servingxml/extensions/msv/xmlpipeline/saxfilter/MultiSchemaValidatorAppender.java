...
public class MultiSchemaValidatorAppender extends AbstractXmlFilterAppender implements XmlValidatorAppender {

  private final VerifierFactory factory = new TheFactoryImpl();
  private final XmlSourceFactory xmlSourceFactory;
  private final ErrorHandler errorHandler;

  public MultiSchemaValidatorAppender(XmlSourceFactory xmlSourceFactory, ErrorHandler errorHandler) {
