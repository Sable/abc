...
public class CachedRecordValidatorAppender extends AbstractRecordFilterAppender     
  ...
  public CachedRecordValidatorAppender(Environment env, XmlSourceFactory xmlSourceFactory,
    Cache cache, RevalidationType revalidationType, ErrorHandler errorHandler) {
    this.env = env;
