...
public class DocumentTest extends TestCase {
  ...
  private static final String PULP_URL = "file:///C:/Projects/servingxml/tests/documents/books/pulp.xml";
  ...
  public void testUncachedSystemContent() throws Exception {
/*
    ...
    ServiceContext context = new DefaultServiceContext("pulp",resources,"text/html",
...
/*
  public void testCachedSystemContent() throws Exception {
    Name documentName = new QualifiedName("pulp");
    RecordBuilder parameters = new RecordBuilder();

    RevalidationType revalidationType = new RevalidationType(true,true);
    URL url = new URL(PULP_URL);
    Content booksAccessor = new CachedSystemContent(documentName,
      url,revalidationType);
  ...
  public void testCachedSystemContent2() throws Exception {
...
/*
  private Content makeBooksContentAccessor() throws Exception {
    ...
    URL url = new URL(PULP_URL);
    Content booksAccessor = new XmlContent(documentName,
      url);
