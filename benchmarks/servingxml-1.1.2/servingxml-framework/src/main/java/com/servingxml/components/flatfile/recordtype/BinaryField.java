...
public class BinaryField implements FlatRecordField {
  ...
  public BinaryField(Name name, Label label, int start, 
  ...
  public FlatRecordFieldReader createFlatRecordFieldReader() {
    FlatRecordFieldReader reader = new BinaryFieldReader(name, start, fieldWidthExpr, 
            defaultValueEvaluator, flatFileOptions);
    return reader;
  }

  public FlatRecordFieldWriter createFlatRecordWriter() {
    FlatRecordFieldWriter writer = new BinaryFieldWriter(name, start, fieldWidthExpr,
    	      defaultValueEvaluator, flatFileOptions);
    return writer;
  }
