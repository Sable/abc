...
public class IntegerFieldWriter implements FlatRecordFieldWriter {
  ...
  public IntegerFieldWriter(Name fieldName, int start, int fieldWidth, DefaultValue defaultValueEvaluator,
