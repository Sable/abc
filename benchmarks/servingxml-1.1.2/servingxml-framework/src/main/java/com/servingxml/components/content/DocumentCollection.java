...
/**
 * A <code>DocumentCollection</code> instance may be used to obtain objects that
...
public class DocumentCollection implements Content {     
  ...
  public DocumentCollection(QnameContext nameContext, 
  ...
  public SaxSource createSaxSource(ServiceContext context, Flow flow) {
    ...
    SaxSource source = new DocumentCollectionSaxSource(context, flow, 
                                                     documentElementName, 
