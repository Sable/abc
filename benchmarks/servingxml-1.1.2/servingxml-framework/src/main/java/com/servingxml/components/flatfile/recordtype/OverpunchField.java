...
public class OverpunchField implements FlatRecordField {
  ...
  public OverpunchField(Name name, Label label, int start, IntegerSubstitutionExpr fieldWidthExpr, 
  ...
  public FlatRecordFieldReader createFlatRecordFieldReader() {
    FlatRecordFieldReader reader = new OverpunchFieldReader(name, start, fieldWidthExpr, decimalPlaces, 
                                     defaultValueEvaluator, flatFileOptions);
    return reader;
  }

  public FlatRecordFieldWriter createFlatRecordWriter() {
    FlatRecordFieldWriter writer = new OverpunchFieldWriter(name, start, fieldWidthExpr, decimalPlaces,
      defaultValueEvaluator, flatFileOptions);
    return writer;
  }
