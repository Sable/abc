...
public class IncludeConfigurationContext extends AbstractConfigurationContext {
  
  public IncludeConfigurationContext(AbstractConfigurationContext parent,
  Element baseElement, ResourceTable resourceTable) {
    super(parent,baseElement,resourceTable);
  }
