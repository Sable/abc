...
public class ContentTaskPrefilter implements ContentTask {
  private final ContentTask contentTask;
  private final ParameterDescriptor[] parameterDescriptors;

  public ContentTaskPrefilter(ContentTask contentTask, ParameterDescriptor[] parameterDescriptors) {
