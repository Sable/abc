...
class RepeatingGroupMapFactory implements MapXmlFactory {

  private final MapXmlFactory tailFactories;
  private final Name fieldName;  

  public RepeatingGroupMapFactory(Name fieldName, MapXmlFactory tailFactories) {
  ...
  public MapXml createMapXml(ServiceContext context) {
    ...
    return new RepeatingGroupMap(fieldName, children);
  }
