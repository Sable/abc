...
public class SqlUpdateDatabasePrefilter implements SqlUpdateDatabase {
  private final SqlUpdateDatabase sqlUpdater;
  private final ParameterDescriptor[] parameterDescriptors;

  public SqlUpdateDatabasePrefilter(SqlUpdateDatabase sqlUpdater, ParameterDescriptor[] parameterDescriptors) {
