...
/**
 * The <code>FindAndReplace</code> class implements the 
 * <code>StringFactory</code> interface. 
 *
 *  
 * @author Daniel A. Parker (daniel.parker@servingxml.com)
 */

public class FindAndReplace implements StringFactory {

  private final PatternMatcher patternMatcher;
  private final Stringable stringFactory;
  private final String replaceWith;

  public FindAndReplace(PatternMatcher patternMatcher, Stringable stringFactory, String replaceWith) {
  ...
  public String createString(ServiceContext context, Flow flow) {
    ...
    patternMatcher.searchAndReplace(input,replaceWith,output);
