...
class FieldElementMapFactory implements MapXmlFactory {
  ...
  public FieldElementMapFactory(QnameContext nameContext, NameSubstitutionExpr nameResolver, ChildEvaluator containerEvaluator,
  ...
  public MapXml createMapXml(ServiceContext context) {
    ...
    MapXml recordMap = new FieldElementMap(nameContext, nameResolver, containerEvaluator, rm);
