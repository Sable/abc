...
public interface SqlUpdateDatabase {
  public static final SqlUpdateDatabase NULL = new NullSqlUpdateDatabase();

  void startUpdate(ServiceContext context, Flow flow, Connection connection);

  void update(ServiceContext context, Flow flow, Connection connection);

  void endUpdate(ServiceContext context, Flow flow, Connection connection);
}

class NullSqlUpdateDatabase implements SqlUpdateDatabase {
