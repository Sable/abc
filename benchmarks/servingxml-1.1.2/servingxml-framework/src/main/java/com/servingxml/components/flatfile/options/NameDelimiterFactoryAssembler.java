...
/**
 * The <code>NameDelimiterFactoryAssembler</code> implements an assembler for
 * assembling <code>NameDelimiter</code> objects.
 *
 * 
 * @author Daniel A. Parker (daniel.parker@servingxml.com)
 */

public class NameDelimiterFactoryAssembler {
  ...
  public NameDelimiterFactory assemble(ConfigurationContext context) {
    ...
    NameDelimiterFactory delimiterFactory = new NameDelimiterFactory(separatorFactory);
