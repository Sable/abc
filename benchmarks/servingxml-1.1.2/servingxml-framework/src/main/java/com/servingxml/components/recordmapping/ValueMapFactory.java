...
class ValueMapFactory implements MapXmlFactory {
  private final ChildEvaluator containerEvaluator;

  public ValueMapFactory(ChildEvaluator containerEvaluator) {
  ...
  public MapXml createMapXml(ServiceContext context) {
    ...
    MapXml recordMap = new ValueMap(containerEvaluator);
