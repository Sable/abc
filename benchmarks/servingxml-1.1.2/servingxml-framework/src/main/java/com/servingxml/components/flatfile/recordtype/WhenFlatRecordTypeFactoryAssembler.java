...
public class WhenFlatRecordTypeFactoryAssembler extends FlatFileOptionsFactoryAssembler {
                                                       
  private String testExpression = "";
  private FlatRecordTypeFactory flatRecordTypeFactory = null;

  public void setTest(String testExpression) {
  ...
  public FlatRecordTypeSelectionFactory assemble(ConfigurationContext context) {
    ...
    FlatRecordTypeSelectionFactory selection = new FlatRecordTypeSelectionFactoryImpl(flatRecordTypeFactory, testExpression, 
                                                                                      assembleFlatFileOptions(context));
    return selection;
  }
}
