...
public class BinaryFieldFactoryAssembler extends FlatFileOptionsFactoryAssembler {
  ...
  public FlatRecordFieldFactory assemble(ConfigurationContext context) {
    ...
    FlatRecordFieldFactory fieldTypeFactory = new BinaryFieldFactory(fieldName,label,
                                                start,widthExpr,
