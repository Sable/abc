...
/**
 * The <code>CurrentDateTime</code> class implements the <code>StringFactory</code> interface.
 *
 *  
 * @author Daniel A. Parker (daniel.parker@servingxml.com)
 */

public class CurrentDateTime implements StringFactory {

  private final DatatypeFactory datatypeFactory;

  public CurrentDateTime(DatatypeFactory datatypeFactory) {
