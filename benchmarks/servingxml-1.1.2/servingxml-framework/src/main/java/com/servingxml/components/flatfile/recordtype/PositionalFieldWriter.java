...
public class PositionalFieldWriter implements FlatRecordFieldWriter {
  ...
  public PositionalFieldWriter(Name fieldName, int start, IntegerSubstitutionExpr fieldWidthExpr, 
  ...
  public void writeEndDelimiterTo(RecordOutput recordOutput) {
    //System.out.println(getClass().getName()+".writeEndDelimiterTo positional");
  }
}
