...
public class SqlQueryPrefilter implements SqlQuery {
  ...
  public String buildSql(ServiceContext context, Flow flow) {
    ...
    return sqlQuery.buildSql(context, newFlow);
  }

  public Name getRecordTypeName() {
    return sqlQuery.getRecordTypeName();
  }
  public boolean isTrimLeading() {
    return sqlQuery.isTrimLeading();
  }
  public boolean isTrimTrailing() {
    return sqlQuery.isTrimTrailing();
  }
}
