...
public class SegmentDelimiterFactory implements DelimiterFactory {

  public static final SegmentDelimiterFactory[] EMPTY_ARRAY = new SegmentDelimiterFactory[0];
  ...
  public SegmentDelimiterFactory(String separator) {
  ...
  public Delimiter createDelimiter(ServiceContext context, Flow flow) {
    ...
    return new SegmentDelimiter(separator);
  }
}
