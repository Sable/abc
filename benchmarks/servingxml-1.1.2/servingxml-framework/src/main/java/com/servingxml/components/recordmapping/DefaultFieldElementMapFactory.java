...
class DefaultFieldElementMapFactory implements MapXmlFactory {
  ...
  public DefaultFieldElementMapFactory(PrefixMap prefixMap, NameTest fields, NameTest except) {
  ...
  public MapXml createMapXml(ServiceContext context) {
    ...
    MapXml handler = new DefaultFieldElementMap(prefixMap,fields, except);
