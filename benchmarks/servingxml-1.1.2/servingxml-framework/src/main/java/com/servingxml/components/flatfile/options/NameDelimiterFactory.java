...
public class NameDelimiterFactory implements DelimiterFactory {

  public static final NameDelimiterFactory[] EMPTY_ARRAY = new NameDelimiterFactory[0];

  private final SeparatorFactory separatorFactory;

  public NameDelimiterFactory(SeparatorFactory separatorFactory) {
  ...
  public Delimiter createDelimiter(ServiceContext context, Flow flow) {
    ...
    return new NameDelimiter(separator);
  }
}
