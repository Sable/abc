...
public class OverpunchFieldFactoryAssembler extends FlatFileOptionsFactoryAssembler {
  ...
  public FlatRecordFieldFactory assemble(ConfigurationContext context) {
    ...
    FlatRecordFieldFactory fieldTypeFactory = new OverpunchFieldFactory(fieldName,label,
                                                start,widthExpr,decimalPlaces,defaultValue,flatFileOptionsFactory);
