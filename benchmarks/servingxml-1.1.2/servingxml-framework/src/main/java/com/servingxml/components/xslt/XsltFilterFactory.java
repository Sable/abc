...
class XsltFilterFactory extends AbstractXsltFilterFactory implements Content {

  public XsltFilterFactory(Environment env, SaxSourceFactory saxSourceFactory, UrlEvaluator docBaseResolver, 
