...
class GenerateCDataFactory implements MapXmlFactory {
  private final Stringable[] stringFactories;
  private final MapXmlFactory childFactories;

  public GenerateCDataFactory(Stringable[] stringFactories, MapXmlFactory childFactories) {
  ...
  public MapXml createMapXml(ServiceContext context) {
    ...
    MapXml recordMap = new GenerateCData(stringFactories,rm);
