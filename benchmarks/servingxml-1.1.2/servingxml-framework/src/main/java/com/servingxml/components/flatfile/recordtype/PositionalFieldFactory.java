...
public class PositionalFieldFactory implements FlatRecordFieldFactory {
  ...
  public PositionalFieldFactory(Name name, Label label, int start, 
  ...
  public void appendFlatRecordField(ServiceContext context, Flow flow, 
    ...
    FlatRecordField field = new PositionalField(name,label,start,fieldWidthExpr,
