...
public class DocumentCollectionSaxSource implements SaxSource {
  ...
  public DocumentCollectionSaxSource(ServiceContext context, Flow flow,
  ...
  public XMLReader createXmlReader() {
    return new DocumentCollectionReader(context, flow, 
                                      documentElementName,
