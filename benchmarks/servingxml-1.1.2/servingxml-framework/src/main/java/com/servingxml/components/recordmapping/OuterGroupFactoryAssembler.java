...
/**
 * The <code>OuterGroupFactoryAssembler</code> implements an assembler for
 * assembling <code>OuterGroupFactory</code> objects.
 *
 * 
 * @author Daniel A. Parker (daniel.parker@servingxml.com)
 */

public class OuterGroupFactoryAssembler {
  ...
  public MapXmlFactory assemble(ConfigurationContext context) {
    ...
    try {
      ...
      MapXmlFactory recordMapFactory = new OuterGroupFactory(env,groupRecognizer,rmf);
