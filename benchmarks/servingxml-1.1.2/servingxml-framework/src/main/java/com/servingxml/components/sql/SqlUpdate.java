...
public class SqlUpdate implements SqlUpdateDatabase {
  private final RecordAccepter accepter;
  private final SqlStatement sqlStatement;
  private Statement statement = null;
  private final SqlUpdateDatabase[] updateOperations;

  public SqlUpdate(RecordAccepter accepter, SqlStatement sqlStatement, SqlUpdateDatabase[] updateOperations) {
