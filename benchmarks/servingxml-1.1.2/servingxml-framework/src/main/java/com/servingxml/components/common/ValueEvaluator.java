...
public interface ValueEvaluator {
  public static final ValueEvaluator EMPTY = new EmptyValueEvaluator();
  public static final ValueEvaluator NULL = new NullValueEvaluator();

  String evaluateString(ServiceContext context, Flow flow);

  String[] evaluateStringArray(ServiceContext context, Flow flow);
...
class EmptyValueEvaluator implements ValueEvaluator {
...
class NullValueEvaluator implements ValueEvaluator {
