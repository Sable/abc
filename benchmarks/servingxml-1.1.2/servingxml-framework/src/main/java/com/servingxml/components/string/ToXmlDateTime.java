...
public class ToXmlDateTime implements StringFactory {
  ...
  public ToXmlDateTime(String fromFormat, Stringable inputFactory, DatatypeFactory datatypeFactory) {
  ...
  public String createString(ServiceContext context, Flow flow) {
    ...
    try {
      ...
      xmlCalendar.setTime(hour,minute,second,millisecond);
