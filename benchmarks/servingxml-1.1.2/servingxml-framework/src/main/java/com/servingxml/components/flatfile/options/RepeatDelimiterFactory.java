...
public class RepeatDelimiterFactory implements DelimiterFactory {

  public static final RepeatDelimiterFactory[] EMPTY_ARRAY = new RepeatDelimiterFactory[0];
  ...
  public RepeatDelimiterFactory(String separator) {
  ...
  public Delimiter createDelimiter(ServiceContext context, Flow flow) {
    ...
    return new RepeatDelimiter(separator);
  }
}
