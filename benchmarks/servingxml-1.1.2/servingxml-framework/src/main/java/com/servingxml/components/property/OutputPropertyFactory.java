...
/**
 * The <code>OutputPropertyFactory</code> is a factory for 
 * creating an <code>OutputProperty</code>. 
 *
 *  
...
public class OutputPropertyFactory {
  ...
  public OutputPropertyFactory(String name, ValueEvaluator valueEvaluator) {
    this.name = name;
  ...
  public OutputProperty createOutputProperty(ServiceContext context, Flow flow) {
    ...
    return new OutputProperty(name,value);
  }
}
