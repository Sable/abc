...
public class ContentPrefilter implements Content {
  private final Content contentFactory;
  private final ParameterDescriptor[] parameterDescriptors;

  public ContentPrefilter(Content contentFactory, ParameterDescriptor[] parameterDescriptors) {
