...
public class DefaultMatchableFactory implements MatchableFactory {
  ...
  public DefaultMatchableFactory(String matchExpr, Selectable[] selectables) {
    this.matchExpr = matchExpr;
    this.selectables = selectables;
  }

  public Matchable createMatchable(String mode) {
    return new DefaultMatchable(mode, matchExpr, selectables);
  }
}
