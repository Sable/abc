...
/**
 * Implements a <tt>FormatDateTimeAssembler</tt> for assembling <tt>ConvertToDateTime</tt> objects. 
 *
 *  
 * @author Daniel A. Parker (daniel.parker@servingxml.com)
 */

public class FormatDateTimeAssembler {
  ...
  public StringFactory assemble(final ConfigurationContext context) {
    ...
    StringFactory converter = new FormatDateTime(format,inputFactory,datatypeFactory);
