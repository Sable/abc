...
public class InverseRecordMappingPrefilter implements InverseRecordMapping {
  private final InverseRecordMapping tail;
  private final ParameterDescriptor[] parameterDescriptors;

  public InverseRecordMappingPrefilter(InverseRecordMapping tail, 
  ...
  public ShredXml createShredXml(ServiceContext context, Flow flow) {
    ...
    return tail.createShredXml(context, newFlow);
  }
}
