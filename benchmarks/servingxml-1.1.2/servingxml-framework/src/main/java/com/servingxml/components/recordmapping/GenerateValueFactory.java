...
class GenerateValueFactory implements MapXmlFactory {
  private final Stringable[] stringFactories;
  private final MapXmlFactory childFactories;

  public GenerateValueFactory(Stringable[] stringFactories, MapXmlFactory childFactories) {
  ...
  public MapXml createMapXml(ServiceContext context) {
    ...
    MapXml recordMap = new GenerateValue(stringFactories,rm);
