...
public class SlashPathEntry implements PathEntry {
  ...
  public boolean matches(SaxPath path, Record parameters) {
    return true;
  }
  ...
  public PathEntry getParent(SaxPath context, Record parameters) {
    PathEntry p = null;
    if (context != null) {
      p = (tail != null && tail.matches(context, parameters)) ? tail : this;
    }
