...
public class BinaryFieldFactory implements FlatRecordFieldFactory {
  ...
  public BinaryFieldFactory(Name name, Label label, int start, 
  ...
  public void appendFlatRecordField(ServiceContext context, Flow flow,
    ...
    FlatRecordField field = new BinaryField(name,label,start,fieldWidthExpr,
      defaultValueEvaluator, settings);
