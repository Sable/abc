...
class ElementMapFactory implements MapXmlFactory {
  ...
  public ElementMapFactory(Environment env, NameSubstitutionExpr nameResolver, Stringable[] stringFactories, MapXmlFactory childFactories) {
    this.env = env;
  ...
  public MapXml createMapXml(ServiceContext context) {
    ...
    MapXml recordMap = new ElementMap(env, nameResolver,EMPTY_ATTRIBUTES, stringFactories,rm);
