...
public class FieldDelimiterFactory implements DelimiterFactory {

  public static final FieldDelimiterFactory[] EMPTY_ARRAY = new FieldDelimiterFactory[0];

  private final SeparatorFactory separatorFactory;

  public FieldDelimiterFactory(SeparatorFactory separatorFactory) {
    this.separatorFactory = separatorFactory;
  }

  public FieldDelimiterFactory(String separator) {
  ...
  public Delimiter createDelimiter(ServiceContext context, Flow flow) {
    ...
    return new FieldDelimiter(separator);
  }
}
