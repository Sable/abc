...
public class StringStreamSourceFactory implements StreamSourceFactory {
  ...
  public StringStreamSourceFactory(String s) {
    SubstitutionExpr subExpr = new LiteralSubstitutionExpr(s);
    this.valueEvaluator = new SubstitutionExprValueEvaluator(subExpr);
  }
  ...
  public StreamSource createStreamSource(ServiceContext context, Flow flow) {
    ...
    StreamSource streamSource = new StringStreamSource(value);
    return streamSource;
  }
}
