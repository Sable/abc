...
public class DomXmlFilterAppenderAssembler {
  ...
  public Content assemble(ConfigurationContext context) {
    ...
    try {
      ...
      Content content = new DomXmlFilterAppender(context.getQnameContext().getPrefixMap(), 
                                                 context.getQnameContext().getBase(), testExprFactory, messageFactory);
