...
/**
 * The <code>EmptyDocumentAssembler</code> implements an assembler for
...
public class EmptyDocumentAssembler {
  ...
  public Content assemble(ConfigurationContext context) {
    ...
    Content contentFactory = new EmptyDocument(xsltConfiguration.getOutputPropertyFactories());
