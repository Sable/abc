...
public class MultivaluedDelimitedField implements FlatRecordField {
  ...
  public MultivaluedDelimitedField(Name fieldName, Label label, int start, int maxFieldWidth,
  ...
  public FlatRecordFieldReader createFlatRecordFieldReader() {
    FlatRecordFieldReader reader = new MultivaluedDelimitedFieldReader(fieldName, start, maxFieldWidth, defaultValue, flatFileOptions);
    return reader;
  }

  public FlatRecordFieldWriter createFlatRecordWriter() {

    FlatRecordFieldWriter writer = new MultivaluedDelimitedFieldWriter(fieldName,start,fieldFormatter,
