...
public interface CommentStarter {
  ...
  public static final CommentStarter NULL = new NullCommentStarter();

  CommentStarterByteChecker createByteCommentStarterChecker(Charset charset);
  CommentStarterCharChecker createCharCommentStarterChecker();
}


final class NullCommentStarter implements CommentStarter {
  public CommentStarterByteChecker createByteCommentStarterChecker(Charset charset) {
    return CommentStarterByteChecker.NULL;
  }
  public CommentStarterCharChecker createCharCommentStarterChecker() {
    return CommentStarterCharChecker.NULL;
  }
}
