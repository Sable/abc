 ...
 * @since 1.2
 * @version $Id: URLCodec.java 480406 2006-11-29 04:56:58 +0000 (Mi, 29 Nov
 *          2006) bayard $
 */
	 ...
	 */
	 ...
	 static protected byte ESCAPE_CHAR = '%';
	/**
	 * BitSet of www-form-url safe characters.
	 */
	 static final protected BitSet WWW_FORM_URL = new BitSet(256);
	...
	/**
											 ...
											 * @return array of bytes containing URL safe characters
											 */
											 static final public byte[] encodeUrl(BitSet urlsafe, byte[] bytes) {
												if (bytes == null) {
													return null;
												}
												if (urlsafe == null) {
	...
	/**
											 ...
											 *             Thrown if URL decoding is unsuccessful
											 */
											 static final public byte[] decodeUrl(byte[] bytes) throws DecoderException {
												if (bytes == null) {
													return null;
												}
												ByteArrayOutputStream buffer = new ByteArrayOutputStream();
