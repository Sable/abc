 ...
 * @since 1.3
 * @version $Id: RFC1522Codec.java 480406 2006-11-29 04:56:58 +0000 (Mi, 29 Nov
 *          2006) bayard $
 */
abstract public                                               class RFC1522Codec {
	 ...
	 */
	 abstract protected byte[] doEncoding(byte[] bytes) throws EncoderException;
	 ...
	 */
	 abstract protected byte[] doDecoding(byte[] bytes) throws DecoderException;
	...
	/**
							 ...
							 */
							 public String encodeText(final String text, final String charset)
	...
	/**
									 ...
									 *             not supported
									 */
									 public String decodeText(final String text) throws DecoderException,
										...
										from = to + 1;
										to = text.indexOf("?", from);
										byte[] data = text.substring(from, to).getBytes(
