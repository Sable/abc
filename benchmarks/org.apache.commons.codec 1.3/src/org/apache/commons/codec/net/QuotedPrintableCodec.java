 ...
 * @since 1.3
 * @version $Id: QuotedPrintableCodec.java 582446 2007-10-06 04:11:49 +0000 (Sa,
 *          06 Okt 2007) bayard $
 */
	 ...
	 */
	 ...
	 static final private byte ESCAPE_CHAR = '=';

	 static final private byte TAB = 9;

	 static final private byte SPACE = 32;
	...
	/**
			 ...
			 */
			 static final private void encodeQuotedPrintable(int b,
	...
	/**
											 ...
											 * @return array of bytes containing quoted-printable data
											 */
											 static final public byte[] encodeQuotedPrintable(BitSet printable,
													byte[] bytes) {
												if (bytes == null) {
													return null;
												}
	...
	/**
											 ...
											 *             Thrown if quoted-printable decoding is unsuccessful
											 */
											 static final public byte[] decodeQuotedPrintable(byte[] bytes)
													throws DecoderException {
												if (bytes == null) {
													return null;
												}
	...
	/**
							 ...
							 */
							 public String decode(String pString, String charset)
								...
								return new String(decode(pString
										.getBytes(CharacterEncodingNames.US_ASCII)), charset);
							}
