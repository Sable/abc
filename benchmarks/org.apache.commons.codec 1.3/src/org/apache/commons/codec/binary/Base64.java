 ...
 * @since 1.0-dev
 * @version $Id: Base64.java 582445 2007-10-06 04:11:24 +0000 (Sa, 06 Okt 2007)
 *          bayard $
 */
public class Base64 implements BinaryEncoder, BinaryDecoder {
	 ...
	 * The base length.
	 */
	 static final private int BASELENGTH = 255;

	/**
	 * Lookup length.
	 */
	 static final private int LOOKUPLENGTH = 64;

	/**
	 * Used to calculate the number of bits in a byte.
	 */
	 static final private int EIGHTBIT = 8;

	/**
	 * Used when encoding something which has fewer than 24 bits.
	 */
	 static final private int SIXTEENBIT = 16;

	/**
	 * Used to determine how many bits data contains.
	 */
	 static final private int TWENTYFOURBITGROUP = 24;

	/**
	 * Used to get the number of Quadruples.
	 */
	 static final private int FOURBYTE = 4;

	/**
	 * Used to test the sign of a byte.
	 */
	 static final private int SIGN = -128;

	/**
	 * Byte used to pad output.
	 */
	 static final private byte PAD = (byte) '=';
	 ...
	 * <code>0</code> through <code>9</code>, followed by <code>+</code>,
	 * and <code>/</code>.
	 * </p>
	 * <p>
	...
	/**
													 ...
													 */
													 static private boolean isBase64(byte octect) {
														if (octect == PAD) {
															return true;
	...
	/**
															 ...
															 */
															 static public boolean isArrayByteBase64(byte[] arrayOctect) {
	...
	/**
			 ...
			 */
			 static public byte[] encodeBase64Chunked(byte[] binaryData) {
	...
	/**
													 ...
													 */
													 static public byte[] encodeBase64(byte[] binaryData, boolean isChunked) {
