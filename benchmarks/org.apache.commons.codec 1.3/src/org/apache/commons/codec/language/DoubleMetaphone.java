 ...
 * @version $Id: DoubleMetaphone.java 480406 2006-11-29 04:56:58 +0000 (Mi, 29
 *          Nov 2006) bayard $
 */
	 ...
	 * "Vowels" to test for
	 */
	 static final private String VOWELS = "AEIOUY";

	/**
	 * Prefixes when present which are not pronounced
	 */
	 static final private String[] SILENT_START = { "GN", "KN", "PN", "WR", "PS" };
	 static final private String[] L_R_N_M_B_H_F_V_W_SPACE = { "L", "R", "N",
			"M", "B", "H", "F", "V", "W", " " };
	 static final private String[] ES_EP_EB_EL_EY_IB_IL_IN_IE_EI_ER = { "ES",
			"EP", "EB", "EL", "EY", "IB", "IL", "IN", "IE", "EI", "ER" };
	 static final private String[] L_T_K_S_N_M_B_Z = { "L", "T", "K", "S", "N",
			"M", "B", "Z" };
	 ...
	 * @return <code>true</code> if the encoded <code>String</code>s are
	 ...
	 */
	 static private boolean contains(String value, int start, int length,
			String criteria) {
	...
	/**
									 ...
									 */
									 private int handleAEIOUY(String value, DoubleMetaphoneResult result,
											int index) {
										if (index == 0) {
											result.append('A');
										}
													 ...
													 */
													 private int handleG(String value, DoubleMetaphoneResult result, int index,
														...
														if (charAt(value, index + 1) == 'H') {
															...
															// -- Italian "biaggi" --//
															if ((contains(value, 0, 4, "VAN ", "VON ") || contains(value, 0, 3,
																	"SCH"))
													 ...
													 */
													 private boolean conditionL0(String value, int index) {
														if (index == value.length() - 3
															...
															return true;
														} else if ((contains(value, index - 1, 2, "AS", "OS") || contains(
	...
	/**
													 ...
													 * <code>length</code>
													 */
													 static protected boolean contains(String value, int start, int length,
															String[] criteria) {
														boolean result = false;
