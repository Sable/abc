// Sorter.java
// $Id: Sorter.java,v 1.7 2000/08/16 21:37:56 ylafon Exp $
...
public class Sorter {
    ...
    public static Vector sortStringEnumeration(Enumeration _enum) {
	Vector sorted = new Vector() ;
	while ( _enum.hasMoreElements() ) 
	    orderedStringInsert((String) _enum.nextElement(), sorted) ;
	sorted.trimToSize();
	return sorted ;
    }
    ...
    public static Vector sortComparableEnumeration(Enumeration _enum) {
	Vector sorted = new Vector() ;
	while ( _enum.hasMoreElements() ) 
	    orderedComparableInsert((Comparable) _enum.nextElement(), sorted) ;
	sorted.trimToSize();
	return sorted ;
    }
