...
// $Id: ResourceStoreImpl.java,v 1.16 2004/08/09 12:16:45 ylafon Exp $
...
public class ResourceStoreImpl implements ResourceStore {
	...
	Enumeration _enum = resources.elements();
	Vector      vres = new Vector(11);
	while (_enum.hasMoreElements()) {
	    Resource res = ((ResourceIndex)_enum.nextElement()).getResource();
	    vres.addElement(res);
	}
