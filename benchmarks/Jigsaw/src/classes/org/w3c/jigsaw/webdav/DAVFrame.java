// DAVFrame.java
// $Id: DAVFrame.java,v 1.38 2004/11/29 13:26:31 ylafon Exp $
...
public class DAVFrame extends PostableFrame {
	...
	if (deadpropmodified) {
	    ...
	    Enumeration     _enum = deadindex.keys();
	    while (_enum.hasMoreElements()) {
		String                ns     = (String)_enum.nextElement();
...
//					 getURL(request).toExternalForm(),
	...
	if (resource instanceof ContainerResource) {
	    ...
	    Enumeration _enum = cresource.enumerateResourceIdentifiers();
	...
	if (request.getDepth() == 0) {
	    ...
	    // Children resource
	    Enumeration       _enum = dresource.enumerateResourceIdentifiers();
	    ResourceReference rr   = null;
	    FramedResource    fr   = null;
	    while (_enum.hasMoreElements()) {
		String name = (String)_enum.nextElement();
