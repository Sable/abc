...
// $Id: NegotiatedFrame.java,v 1.41 2004/01/13 16:16:54 ylafon Exp $
...
public class NegotiatedFrame extends HTTPFrame {
	...
	// ok let's do it!
	vary_done = true;
	boolean b_charset = false;
	boolean b_type = false;
	boolean b_language = false;
	boolean b_encoding = false;
	...
	Boolean val = (Boolean) getValue(ATTR_PUT_POLICY, null); 
	if (val == null) // strict by default 
	    return false; // not paranoid -- only check when editing variants 
	return val.booleanValue(); 
    }
