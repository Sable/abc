...
public class ProgressBar extends Canvas {
	...
	public void setFProgressX(int fProgressX) {
		this.fProgressX = fProgressX;
	}

	public int getFProgressX() {
		return fProgressX;
	}
	...
	public void paintStatus(Graphics g) {
		...
		Rectangle r= new Rectangle(0, 0, getFProgressX(), getBounds().height);
	...
	public void setBounds(int x, int y, int w, int h) {
		...
		setFProgressX(scale(fProgress123));
	}
